...
namespace ViamaticaAPI.Controllers
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        public ComentariosController(ViaMaticaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Comentario>> PostComentario(Comentario comentario)
        {
          if (_context.Comentarios == null)
          {
              return Problem("Entity set 'ViaMaticaDbContext.Comentarios'  is null.");
          }
